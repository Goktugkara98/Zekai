...
# OPENROUTER SERVICE
# =============================================================================
# Bu dosya, OpenRouter API ile iletişim kurar.
# =============================================================================
...
class OpenRouterService:
    ...
    def set_site_info(self, site_url: str = None, site_name: str = None):
        """Site bilgilerini ayarla (opsiyonel)"""
        if site_url:
    ...
    def test_connection(self) -> Dict[str, Any]:
        ...
        try:
            ...
            test_result = self.generate_content(
                prompt="Test",
            ...
            return {
                ...
                "message": "OpenRouter bağlantısı başarılı" if test_result["success"] else "Bağlantı hatası",
    ...
    def generate_content(self, prompt: str, conversation_history: List[Dict] = None, **kwargs) -> Dict[str, Any]:
        ...
        Args:
            ...
            conversation_history (List[Dict]): Konuşma geçmişi
        ...
        try:
            ...
            return {
                "success": False,
                "error": f"İçerik oluşturma hatası: {str(e)}"
            }
